...
if ( ! function_exists('lyh_breadcrumbs') ) :

  function lyh_breadcrumbs() {

      // Settings
      //&gt;
      $separator          = '/';
      $breadcrumbs_id      = '';
      $breadcrumbs_class   = 'lyh-breadcrumbs';
      $home_title         = 'Home';
      ...
      if ( !is_front_page() ) {
          ...
          $output = '<ul id="' . $breadcrumbs_id . '" class="' . $breadcrumbs_class . '">';

          // Home page
          $output .= '<li class="item-home"><a class="bread-link bread-home" href="' . get_home_url() . '" title="' . $home_title . '">' . $home_title . '</a></li>';
          $output .= '<li class="lyh-breadcrumb-separator separator-home"> ' . $separator. ' </li>';
          ...
          if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
              ...
              if($post_type != 'post') {
                  ...
                  $output .= '<li class="lyh-breadcrumb-separator"> ' . $separator . ' </li>';
              ...
              if(!empty($category)) {
                  ...
                  // Get any parent categories and create array
                  ...
                  foreach($cat_parents as $parents) {
                      ...
                      $cat_display .= '<li class="lyh-breadcrumb-separator"> ' . $separator . ' </li>';
                  }
              ...
              if(empty($last_category) && !empty($custom_taxonomy) && $taxonomy_exists) {
                ...
                $output .= get_product_categories( $post->ID, $custom_taxonomy, 0);

                if ( sizeOf($taxonomy_terms) > 0 && !wp_is_mobile() ) {

                  $output .= get_product_categories( $post->ID, $custom_taxonomy, 1 );

                }

                $output .= '<li class="item-current item-' . $post_id . '"><strong class="bread-current bread-' . $post_id . '" title="' . get_the_title() . '">' . get_the_title() . '</strong></li>';
              ...
              if( $post->post_parent ){
                  ...
                  foreach ( $anc as $ancestor ) {
                      ...
                      $parents .= '<li class="lyh-breadcrumb-separator separator-' . $ancestor . '"> ' . $separator . ' </li>';
                  }
              ...
              $output .= '<li class="lyh-breadcrumb-separator separator-' . get_the_time('Y') . '"> ' . $separator . ' </li>';
              ...
              $output .= '<li class="lyh-breadcrumb-separator separator-' . get_the_time('m') . '"> ' . $separator . ' </li>';
