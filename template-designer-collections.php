<?php /* Template Name: Designer Collections */ ?>

<?php get_header(); ?>

<?php echo do_shortcode('[rev_slider alias="holiday_sale_end_12-20-19-1"][/rev_slider]'); ?>
                    ...
                    <div class="row justify-content-center">
                      <div class="col-lg-12 col-12 mt-2">
                        ...
                        <div class="mb-2" style="text-align: center;">
                          <a href="<?php echo site_url('/product-category/generation-lighting/ellen-degeneres-collection'); ?>"><button type="button" class="button">Shop ED Collection</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-8 col-md-8 col-12" style="background-color: #fbfbfb;">
                    <div class="row justify-content-center">
                      <div class="col-lg-12 col-12 mt-2">
                        ...
                        <div class="mb-2" style="text-align: center;">
                          <a href="<?php echo site_url('/product-category/generation-lighting/chapman-myers-collection'); ?>"><button type="button" class="button">Shop Chapman & Myers Collection</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-8 col-md-8 col-12" style="background-color: #fbfbfb;">
                    <div class="row justify-content-center">
                      <div class="col-lg-12 col-12 mt-2">
                        ...
                        <div class="mb-2" style="text-align: center;">
                          <a href="<?php echo site_url('/product-category/generation-lighting/kelly-wearstler-collection'); ?>"><button type="button" class="button">Shop Kelly Collection</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
...
sympathetic to the most practical ideas of home.</p>
                        </div>
                        <div class="mb-2" style="text-align: center;">
                          <a href="<?php echo site_url('/product-category/generation-lighting/thomas-obrien-collection'); ?>"><button type="button" class="button">Shop TOB Collection</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
