jQuery(function($) {
  ...
  $('body').on('click', '.tfs-remove' ,function(e) {
    ...
    let thank_you_page_coupon_copy_to_clipboard = function() {

        $('#tfs-ty-coupon-copy-to-clipboard').click(function() {

            $('#tfs-ty-coupon-text-area').select();

            document.execCommand('copy');

            $('#tfs-ty-coupon-copy-to-clipboard').replaceWith('Copied!');

        });

    }

    if ( $('#tfs-ty-coupon-copy-to-clipboard') ) {

      thank_you_page_coupon_copy_to_clipboard();
