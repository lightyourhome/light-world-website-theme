...
function enqueue_light_world_scripts() {
	wp_enqueue_style( 'light-world-style', get_template_directory_uri() . '/style.css', array(), '1.0.6' );
	...
	/* Single Product JS */
	wp_enqueue_script( 'woocommerce-single-product-scripts', get_template_directory_uri() . '/js/woo_single_product.js', array(), '1.0.6', true );
