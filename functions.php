...
function enqueue_light_world_scripts() {
	wp_enqueue_style( 'light-world-style', get_template_directory_uri() . '/style.css', array(), '05212020' );
	...
	/* Search Bar JS */
	wp_enqueue_script( 'mobile-search-bar-js', get_template_directory_uri() . '/js/mobile_search_init.js', array(), '12262019', true);

	/* Color Swatch JS */
	wp_enqueue_script( 'woocommerce-product-swatches', get_template_directory_uri() . '/js/swatch_slider_1.0.js', array(), '03112020', true);

	/* Single Product JS */
	wp_enqueue_script( 'woocommerce-single-product-scripts', get_template_directory_uri() . '/js/woo_single_product.js', array(), '04132020', true );
