<?php /* Template Name: Quoizel Lighting */ ?>
    ...
    <div class="row justify-content-center">
           ...
           <div id="brand-page_heading_image" class="col-md-8">
			  <div class="prod_cat_img">
                <img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/08/quoizel_summer_sale.jpg">
              </div>
			</div>
            ...
            <div class="row h-100 justify-content-center">
                <div class="col-lg-12 col-12 my-auto">
                    <div class="prod_cat_text title-container" style="padding: 10px;">
                        <h2 class="prod-cat-title">Quoizel Lighting</h2>
                    </div>
                </div>
            </div>
            ...
            <main id="main" class="site-main" role="main">
                ...
                <div class="row mb-4 mt-4">
                    ...
                    <div class="col-sm-12 mb-5 pb-2" style="border-bottom: 2px solid #d3d3d3;">
                        <h2>Quoizel Lighting Categories</h2>
                    </div>
                    ...
                    <div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-chandeliers'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/04/TNR5008EK.jpg">', wp_get_attachment_metadata(16812),16812  ); ?>
                                <div class="pb-3 pt-3">
                    ...
                    <div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-bath-and-vanity'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/05/EDS8603BN_3_.jpg">', wp_get_attachment_metadata(16945), 16945 ); ?>
								 <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-pendants'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/04/QPP4028WS_3_.jpg">', wp_get_attachment_metadata(14547), 14547 ); ?>
								 <div class="pb-3 pt-3">
                    ...
                    <div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-outdoor'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                ...
                                <div class="pb-3 pt-3">
                                    <h3 class="brand-page_cat_headings" style="text-align: center;" class="mb-2">Outdoor</h3>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-sconces'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/03/SQR8701RK_3_-2.jpg">', wp_get_attachment_metadata(12631), 12631 ); ?>
                                <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-flush-mounts'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/04/RBN1616SG.jpg">', wp_get_attachment_metadata(13908), 13908 ); ?>
                                <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-semi-flush-mounts'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/04/FTR1713IB.jpg">', wp_get_attachment_metadata(13519), 13519 ); ?>
                                <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoziel-lighting/quoizel-table-lamps'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/05/TFNO6325VA.jpg">', wp_get_attachment_metadata(22449), 22449 ); ?>
                                <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-floor-lamps'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/05/TFVT9362VB.jpg">', wp_get_attachment_metadata(22464), 22464 ); ?>
                                <div class="pb-3 pt-3">
					...
					<div class="col-sm-4 col-6 mt-5">
                        ...
                        <a href="<?php echo site_url('/product-category/quoizel-lighting/quoizel-mirrors'); ?>">
                            <div class="brand-page_cat_image_container pt-3">
                                <?php echo wp_image_add_srcset_and_sizes('<img style="height: auto; width: 100%;" src="/wp-content/uploads/2019/05/UPRZ43426C.jpg">', wp_get_attachment_metadata(22820), 22820 ); ?>
                                <div class="pb-3 pt-3">
                    ...
                    <div class="col-md-12 mt-5 button-container" style="text-align: center;">
                        <div class="mb-5 mt-5">
                            <a href="<?php echo site_url('/product-category/quoizel-lighting'); ?>">
                                <button class="button">Shop All Quoizel Lighting</button>
                            </a>
                        </div>
                    </div>

                    <div class="col-md-12 pb-2 mb-5 mt-5" style="border-bottom: 2px solid #d3d3d3;">
                        <h2>Popular Quoizel Products</h2>
                    </div>

                    <div class="col-md-12">
                        <?php echo do_shortcode('[products limit="6" columns="3" best_selling="true" category="quoizel-lighting" ]'); ?>
                    </div>
